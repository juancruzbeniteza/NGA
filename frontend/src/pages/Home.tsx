...
import { ArrowRight, Shield, TrendingUp, Landmark, ArrowUpRight, BarChart3, Zap, Layers, Briefcase, Users } from 'lucide-react';
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#F8FAFC] py-20">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full text-center">
        ...
        >
          ...
          >
            <Link to="/contacto" className="group relative w-full sm:w-80 bg-blue-600 text-white py-6 rounded-[2.5rem] text-xl font-black italic uppercase tracking-tighter hover:bg-blue-700 transition-all flex items-center justify-center shadow-2xl shadow-blue-100 overflow-hidden">
            ...
            <Link to="/mercado" className="w-full sm:w-auto flex items-center justify-center space-x-3 px-10 py-6 text-xl font-black uppercase italic tracking-tighter text-slate-700 hover:text-blue-600 transition-all group">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 relative z-10 text-center lg:text-left">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-20">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
            <Link to="/contacto" className="inline-flex w-full sm:w-auto items-center justify-center px-16 py-8 bg-blue-600 text-white rounded-[3rem] text-3xl font-black hover:bg-blue-700 transition-all shadow-2xl shadow-blue-900/50 uppercase italic tracking-tighter">
              Contactar
              <ArrowRight className="ml-6 text-white" size={32} />
            </Link>
          </motion.div>
        </div>
      </div>
