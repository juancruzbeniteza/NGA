        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="flex space-x-4">
            {[MapPin, Mail, MessageSquare].map((Icon, i) => (
              <motion.a 
                key={i}
                whileHover={{ y: -5, scale: 1.1, color: '#f97316' }}
                href="#" 
                className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center text-slate-500 border border-white/5 transition-all"
              >
                <Icon size={20} />
              </motion.a>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-4">
            {[
              ...
              <li key={link.name}>
                <Link to={link.path} className="text-slate-400 hover:text-orange-500 font-bold flex items-center group transition-colors uppercase italic text-sm tracking-tighter">
        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              <Globe className="text-orange-500 mt-1 shrink-0" size={18} />
