        ...
        <div>
          ...
          <ul className="space-y-4">
            {[
              ...
              <li key={link.name}>
                <Link to={link.path} className="text-slate-400 hover:text-blue-500 font-bold flex items-center group transition-colors uppercase italic text-sm tracking-tighter">
